...
export const MessageList = ({
    ...
    canLoadMore,data,isLoadingMore,loadMore,channelCreationTime,channelName,
    memberImage,memberName,variant
}:MessageListProps) =>{
          ...
          {Object.entries(groupedMessages || {}).map(([datekey, messages]) => (
            <div key={datekey}>
                ...
                {messages?.map((message:any ,index:any) =>{
                    ...
                    differenceInMinutes(new Date(message._creationTime),
